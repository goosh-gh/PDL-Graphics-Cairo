#!/usr/bin/env perl
# =============================================================
# example_png.pl  —  PDL::Graphics::Cairo PNG 出力デモ
#
# 実行方法（PDL-Graphics-Cairo/ ルートから）:
#   perl -I./lib examples/example_png.pl
#   perl -I./lib examples/example_png.pl ~/Desktop/plots   # 出力先を指定
#
# インストール済みの場合:
#   perl examples/example_png.pl
#
# 出力ファイル:
#   ex01_line.png       折れ線・線種・凡例・グリッド
#   ex02_scatter.png    散布図（カラーマップ・マーカー各種）
#   ex03_bar_hist.png   棒グラフ（縦・横）+ ヒストグラム
#   ex04_errorbar.png   エラーバー + fill_between 信頼帯
#   ex05_step_stem.png  step / stem プロット
#   ex06_pie.png        円グラフ
#   ex07_imshow.png     imshow カラーマップギャラリー
#   ex08_contourf.png   contourf 等高線塗り
#   ex09_annotate.png   annotate / axvspan / axhspan
#   ex10_logscale.png   対数スケール（semilog-y / log-log）
#   ex11_twinx.png      twinx 左右 2 軸
#   ex12_dashboard.png  統計ダッシュボード（2x2 subplot）
# =============================================================
...
# =============================================================
{
    ...
    $ax->title("contourf  \x{2014}  sin(x)\x{00B7}cos(y)");
